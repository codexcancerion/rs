    ...
    // <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">Titles</h2>
          {resTitles.length > 0 ? (
        ...
        <section className="mb-8">
          ...
          {resObjectives.length > 0 ? (
            resObjectives.map((objective) => (
              <div key={objective.id} className="mb-4 p-4 border rounded-md bg-gray-50">
                <p className="text-gray-700"><strong>Objective:</strong> {objective.objective}</p>
